...
import com.mega.map.common.command.map1.Game2Command;
import com.mega.map.common.command.map2.GameGhostModeCommand;
import com.mega.map.common.command.map2.Map2Command;
...
public class XtyCommands {
    ...
    public static void load(RegisterCommandsEvent event) {
        event.getDispatcher().register(
                LiteralArgumentBuilder.<CommandSourceStack>literal("endinglib:map")
                        ...
                        .then(InteractionCommand.register())
