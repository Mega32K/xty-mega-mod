package com.mega.map.common.network;
...
import com.mega.map.common.network.c2s.map1.game2.C2SPlayerLaydownPacket;
import com.mega.map.common.network.c2s.map1.game2.C2SPlayerSwingHandNoticePacket;
import com.mega.map.common.network.c2s.map2game2.C2SSetGame2ClientOptionPacket;
import com.mega.map.common.network.c2s.map2.C2SSetNamePacket;
import com.mega.map.common.network.c2s.map2.C2SStopJoiningGamePacket;
import com.mega.map.common.network.c2s.warehouse.C2SApplyWeaponWarehouseLoadoutPacket;
import com.mega.map.common.network.c2s.warehouse.C2SSaveWeaponWarehousePacket;
import com.mega.map.common.network.s2c.S2CDisableBIPacket;
import com.mega.map.common.network.s2c.S2CPartialTeleportPacket;
...
import com.mega.map.common.network.s2c.fps.S2CRoundLoseRenderPacket;
import com.mega.map.common.network.s2c.fps.S2CRoundStartRenderPacket;
import com.mega.map.common.network.s2c.fps.S2CRoundWinRenderPacket;
...
import com.mega.map.common.network.s2c.map2.*;
import com.mega.map.common.network.s2c.map2.game2.S2CDeadPostEffectPacket;
import com.mega.map.common.network.s2c.map2.game2.S2CGame2DeathEffectPacket;
import com.mega.map.common.network.s2c.map2.game2.S2CGame2StartEffectPacket;
...
import com.mega.map.common.network.s2c.warehouse.S2COpenWeaponWarehousePacket;
import com.mega.map.common.network.s2c.warehouse.S2CSyncWeaponWarehousePacket;
...
public class NetworkHandler {
    public static SimpleChannel INSTANCE = NetworkRegistry.newSimpleChannel(ResourceLocation.fromNamespaceAndPath(MegaMod.MODID, "megamod_packet"), () -> "1", (s) -> true, (s) -> true);
    ...
    public static void registerPackets() {
        ...
        INSTANCE.registerMessage(id(), com.mega.map.common.network.s2c.map2.game2.S2CGame2StatsPacket.class, com.mega.map.common.network.s2c.map2.game2.S2CGame2StatsPacket::encode, com.mega.map.common.network.s2c.map2.game2.S2CGame2StatsPacket::decode, com.mega.map.common.network.s2c.map2.game2.S2CGame2StatsPacket::handle);
        ...
        INSTANCE.registerMessage(id(), S2CRoundWinSoundPacket.class, S2CRoundWinSoundPacket::encode, S2CRoundWinSoundPacket::decode, S2CRoundWinSoundPacket::handle);
        ...
        INSTANCE.registerMessage(id(), S2CWeaponWarehouseBlacklistPacket.class, S2CWeaponWarehouseBlacklistPacket::encode, S2CWeaponWarehouseBlacklistPacket::decode, S2CWeaponWarehouseBlacklistPacket::handle);
