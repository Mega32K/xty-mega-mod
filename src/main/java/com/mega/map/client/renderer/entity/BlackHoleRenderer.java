...
import com.mega.map.common.entity.BlackHoleEntity;
...
public class BlackHoleRenderer extends EntityRenderer<BlackHoleEntity> {
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(MegaMod.MODID, "textures/entity/blackhole.png");

    private static final ResourceLocation BEAM_TEXTURE = ResourceLocation.fromNamespaceAndPath(MegaMod.MODID, "textures/entity/beam.png");
