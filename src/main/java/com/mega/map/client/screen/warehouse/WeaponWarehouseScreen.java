package com.mega.map.client.screen.warehouse;
...
import com.mega.map.common.warehouse.WeaponWarehouseSlotType;
...
public class WeaponWarehouseScreen extends Screen {
    private static final ResourceLocation GUI_PANEL = ResourceLocation.fromNamespaceAndPath(MegaMod.MODID, "textures/ui/fps/gui_icons.png");
    private static final ResourceLocation GUI_PANEL_HIGHLIGHT = ResourceLocation.fromNamespaceAndPath(MegaMod.MODID, "textures/ui/fps/gui_icons_highlight.png");
    private static final ResourceLocation SLIDER = ResourceLocation.fromNamespaceAndPath(MegaMod.MODID, "textures/ui/fps/slider.png");
    private static final ResourceLocation SLIDER_HIGHLIGHTED = ResourceLocation.fromNamespaceAndPath(MegaMod.MODID, "textures/ui/fps/slider_highlighted.png");
    private static final ResourceLocation SLIDER_HANDLE = ResourceLocation.fromNamespaceAndPath(MegaMod.MODID, "textures/ui/fps/slider_handle.png");
    private static final ResourceLocation SLIDER_HANDLE_HIGHLIGHTED = ResourceLocation.fromNamespaceAndPath(MegaMod.MODID, "textures/ui/fps/slider_handle_highlighted.png");
    ...
    public WeaponWarehouseScreen() {
        super(Component.translatable("screen.megamod.weapon_warehouse.title"));
    ...
    protected void init() {
        ...
        this.searchBox = new WarehouseSearchBox(this.font, searchX(), panelY + 22, searchWidth(), SEARCH_FIELD_HEIGHT,
                Component.translatable("screen.megamod.weapon_warehouse.search"), SEARCH_PLACEHOLDER);
        ...
        for (int i = 0; i < WeaponWarehouseItems.LOADOUT_COUNT; i++) {
            ...
            WeaponWarehouseButton button = new WeaponWarehouseButton(loadoutButtonX(), panelY + 24 + i * 26, loadoutButtonWidth(), 20,
                    Component.translatable("screen.megamod.weapon_warehouse.loadout", i + 1), pressed -> {
        ...
        this.applyButton = addRenderableWidget(new WeaponWarehouseButton(searchX(), panelY + panelHeight() - 28, 84, 20,
                Component.translatable("screen.megamod.weapon_warehouse.apply"), button -> {
        ...
        this.saveButton = addRenderableWidget(new WeaponWarehouseButton(searchX() + 92, panelY + panelHeight() - 28, 84, 20,
                Component.translatable("screen.megamod.weapon_warehouse.save"), button -> {
            this.snapshot.setSelectedLoadout(this.selectedLoadout);
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        graphics.drawString(this.font, Component.translatable("screen.megamod.weapon_warehouse.tip"), searchX(), panelY + 8, 0xFFAAB6C8);
    ...
    private void renderSlotGrid(MegaGuiGraphics graphics, int mouseX, int mouseY) {
        ...
        for (WeaponWarehouseSlotType slotType : WeaponWarehouseSlotType.values()) {
            ...
            if (!stack.isEmpty()) {
                ...
                graphics.drawString(this.font, Component.translatable("screen.megamod.weapon_warehouse.empty"), x + 6, y + 22, 0xFF7F8A99);
            }
        }
    }
    ...
    private void renderCandidatePanel(MegaGuiGraphics graphics, int mouseX, int mouseY) {
        ...
        graphics.drawString(this.font, Component.translatable("screen.megamod.weapon_warehouse.candidates"), x + 8, y + 6, 0xFFE8EEF7);
        ...
        for (int i = 0; i < visibleCount; i++) {
            ...
            } else graphics.blit(ResourceLocation.fromNamespaceAndPath(MegaMod.MODID, "textures/ui/fps/locked_button.png"), x + 9, itemY, 0, 0, 20, 20 ,20, 20);
