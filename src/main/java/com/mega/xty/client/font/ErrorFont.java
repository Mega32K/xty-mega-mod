package com.mega.xty.client.font;
...
import com.mega.xty.mixin.client.AccessorEmptyTextureStateShard;
import com.mega.xty.mixin.client.AccessorRenderTypeCompositeRenderType;
import com.mega.xty.mixin.client.AccessorRenderTypeCompositeState;
...
public class ErrorFont extends Font {
    ...
    private static final class ErrorFontRenderTypes extends RenderType {
        ...
        private static final Function<ResourceLocation, RenderType> TEXT = Util.memoize(texture ->
                create("xtymegamod:error_font_text", DefaultVertexFormat.POSITION_COLOR_TEX_LIGHTMAP, VertexFormat.Mode.QUADS, 256, false, true,
        ...
        private static final Function<ResourceLocation, RenderType> TEXT_SEE_THROUGH = Util.memoize(texture ->
                create("xtymegamod:error_font_text_see_through", DefaultVertexFormat.POSITION_COLOR_TEX_LIGHTMAP, VertexFormat.Mode.QUADS, 256, false, true,
                        CompositeState.builder()
                                .setShaderState(LOGO_GLITCH_TEXT_SHADER)
                                .setTextureState(new TextureStateShard(texture, false, false))
                                .setTransparencyState(TRANSLUCENT_TRANSPARENCY)
        ...
        private static final Function<ResourceLocation, RenderType> TEXT_POLYGON_OFFSET = Util.memoize(texture ->
                create("xtymegamod:error_font_text_polygon_offset", DefaultVertexFormat.POSITION_COLOR_TEX_LIGHTMAP, VertexFormat.Mode.QUADS, 256, false, true,
                        CompositeState.builder()
                                .setShaderState(LOGO_GLITCH_TEXT_SHADER)
                                .setTextureState(new TextureStateShard(texture, false, false))
                                .setTransparencyState(TRANSLUCENT_TRANSPARENCY)
        ...
        private static final Function<ResourceLocation, RenderType> TEXT_INTENSITY = Util.memoize(texture ->
                create("xtymegamod:error_font_text_intensity", DefaultVertexFormat.POSITION_COLOR_TEX_LIGHTMAP, VertexFormat.Mode.QUADS, 256, false, true,
                        CompositeState.builder()
        ...
        private static final Function<ResourceLocation, RenderType> TEXT_INTENSITY_SEE_THROUGH = Util.memoize(texture ->
                create("xtymegamod:error_font_text_intensity_see_through", DefaultVertexFormat.POSITION_COLOR_TEX_LIGHTMAP, VertexFormat.Mode.QUADS, 256, false, true,
                        CompositeState.builder()
                                .setShaderState(LOGO_GLITCH_TEXT_INTENSITY_SHADER)
                                .setTextureState(new TextureStateShard(texture, false, false))
                                .setTransparencyState(TRANSLUCENT_TRANSPARENCY)
        ...
        private static final Function<ResourceLocation, RenderType> TEXT_INTENSITY_POLYGON_OFFSET = Util.memoize(texture ->
                create("xtymegamod:error_font_text_intensity_polygon_offset", DefaultVertexFormat.POSITION_COLOR_TEX_LIGHTMAP, VertexFormat.Mode.QUADS, 256, false, true,
                        CompositeState.builder()
                                .setShaderState(LOGO_GLITCH_TEXT_INTENSITY_SHADER)
                                .setTextureState(new TextureStateShard(texture, false, false))
                                .setTransparencyState(TRANSLUCENT_TRANSPARENCY)
