...
public class FillFunctionCreatorDebugModule implements DebugModule {
    ...
    private final ClickOverlayButton leftClick = new ClickOverlayButton(Component.translatable("ui.xtymegamod.debug.selected_first"));
    private final ClickOverlayButton rightClick = new ClickOverlayButton(Component.translatable("ui.xtymegamod.debug.selected_second"));
                    ...
                    .setConsumer(player -> {
                        ...
                        CompletableFuture.runAsync(() -> {
                            ...
                            if (component != null && component.use().isPresent()) {
                                ...
                                try {
                                    Path path = FMLLoader.getGamePath().resolve(XtyMegaMod.MODID).resolve("fill_functions");
                                    ...
                                    player.sendSystemMessage(Component.translatable("ui.xtymegamod.debug.save.success",
