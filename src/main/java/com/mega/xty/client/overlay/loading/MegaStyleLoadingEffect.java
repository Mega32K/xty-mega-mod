package com.mega.xty.client.overlay.loading;
...
import com.mega.xty.mixin.client.LoadingOverlayAccessor;
...
public class MegaStyleLoadingEffect {
    ...
    static ResourceLocation MOJANG = ResourceLocation.fromNamespaceAndPath(XtyMegaMod.MODID, "textures/ui/mojangstudios.png");
