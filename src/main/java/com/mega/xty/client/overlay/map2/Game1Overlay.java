...
public class Game1Overlay implements IGuiOverlay {
    public static final BlitInfo EMPTY_SKULL = new BlitInfo(
            ResourceLocation.fromNamespaceAndPath(XtyMegaMod.MODID, "textures/ui/empty_skull.png"),
            0, 0, 512, 512
    );
    public static final BlitInfo SKULL = new BlitInfo(
            ResourceLocation.fromNamespaceAndPath(XtyMegaMod.MODID, "textures/ui/skull.png"),
            0, 0, 512, 512
    );
    @Override
