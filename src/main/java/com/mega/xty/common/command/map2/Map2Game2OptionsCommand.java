        ...
        return Commands.literal(name)
                .then(Commands.literal("set")
                        .then(Commands.argument("value", IntegerArgumentType.integer(0))
                                .executes(context -> {
                                    ...
                                    context.getSource().sendSuccess(() -> Component.translatable("commands.xtymegamod.message.map2.game2.options.server.set", displayName, current), false);
                                    return current;
                                })))
                .then(Commands.literal("get")
                        .executes(context -> {
                            ...
                            context.getSource().sendSuccess(() -> Component.translatable("commands.xtymegamod.message.map2.game2.options.server.get", displayName, value), false);
                            return value;
                        }));
    }
                        ...
                        .then(Commands.argument("targets", EntityArgument.players())
                                .then(Commands.argument("value", BoolArgumentType.bool())
                                        .executes(context -> {
                                            ...
                                            int count = changed;
                                            context.getSource().sendSuccess(() -> Component.translatable("commands.xtymegamod.message.map2.game2.options.client.set", count, displayName, value), false);
                                            return changed;
                                        }))))
                .then(Commands.literal("get")
                        .then(Commands.argument("target", EntityArgument.player())
                                .executes(context -> {
                                    ...
                                    context.getSource().sendSuccess(() -> Component.translatable("commands.xtymegamod.message.map2.game2.options.client.get", player.getGameProfile().getName(), displayName, value), false);
                                    return value ? 1 : 0;
                                })));
    }
