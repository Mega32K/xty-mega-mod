...
public class Game2WarehouseMeleeCommand {
    ...
    private static int add(CommandSourceStack sourceStack, ServerPlayer target) {
        ...
        sourceStack.sendSuccess(() -> Component.translatable("commands.xtymegamod.message.map2.game2.warehouse_melee.add", stack.getHoverName()), false);
        return stacks.size();
    }
    ...
    private static int remove(CommandSourceStack sourceStack, ServerPlayer target) {
        ...
        data.setExtraWarehouseMeleeStacks(stacks);
        sourceStack.sendSuccess(() -> Component.translatable("commands.xtymegamod.message.map2.game2.warehouse_melee.remove", stack.getHoverName()), false);
        return stacks.size();
    }
    ...
    private static int clear(CommandSourceStack sourceStack) {
        ...
        sourceStack.sendSuccess(() -> Component.translatable("commands.xtymegamod.message.map2.game2.warehouse_melee.clear"), false);
        return 0;
    }
    ...
    private static int get(CommandSourceStack sourceStack) {
        ...
        sourceStack.sendSuccess(() -> Component.translatable("commands.xtymegamod.message.map2.game2.warehouse_melee.get", value), false);
